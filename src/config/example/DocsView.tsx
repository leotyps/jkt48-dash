...
function DocsView() {
  ...
  const features = [
    ...
    { name: 'Get All Live Member JKT48', url: '/api/live', premium: true },
    { name: 'Get IDN Live Member JKT48', url: '/api/live/idn', premium: true },
    { name: 'Get Showroom Live Member JKT48', url: '/api/live/showroom', premium: true },
