...
function DocsView() {
  ...
  const features = [
    ...
    { name: 'Create Payment Qris ORKUT', url: '/api/createpayment?amount=xxx&qris=xxx', premium: false },
    { name: 'Check Payment Status ORKUT', url: '/api/cekstatus?merchant=xxxx&keyorkut=xxxx&amount=xxxx', premium: false },
